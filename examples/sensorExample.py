...
if __name__ == "__main__":
    ...
    while True:
        ...
        if cnt % 20 == 0:
            print("[L ] [LF] [LC] [CR] [RF] [ R]  [BATT]")

        print(
            f"{sensors[names[0]]:4} {sensors[names[1]]:4} {sensors[names[2]]:4} {sensors[names[3]]:4} {sensors[names[4]]:4} {sensors[names[5]]:4}   {sensors[names[6]]:4}")
        time.sleep(.01)
